...
public class NumberOpsDriver {
   ...
   public static void main(String[] args) {
      ...
      // get first user numIn using in.nextInt()
      numIn = in.nextInt();
      // add a while loop as described below: 
   	// while the numIn is not equal to 0 
         // add a new NumberOperations object to numOpsList based on user numIn
         // get the next user numIn using in.nextInt()
      while (numIn != 0) {
         NumberOperations numOps = new NumberOperations(numIn);
      ...
      while (index < numOpsList.size()) {
         ...
         System.out.print("\tPowers of 2 Under:" + "\t" + num.powersTwoUnder() + "\n");
